...
print( '--------------' )
print( 'Note: Be sure to add a check point shortly after the start-finish')
print( '\tline. This will be used to ensure the AI drivers are actually' )
print( '\tdriving forwards. If they don\'t reach a check point, or one is' )
print( '\tnot added, the trainer will assume they are not driving and' )
print( '\tthey will be removed. This will cause issues with training.' )
print( '--------------' )
print( 'Note: It is recommended to add a check point shortly before the' )
print( '\tstart-finish line as well. This will ensure that AI drivers do' )
print( '\tnot end up driving the wrong way around the track.' )
print( '--------------' )
print( 'Note: The saving process takes a minute as the track has to be' )
print( '\tchecked to ensure there are no errors. The command prompt will' )
print( '\toutput a message when saving is complete.' )
print( '--------------' )
